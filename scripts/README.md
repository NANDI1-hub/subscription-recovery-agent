...
- Support WhatsApp notifications alongside email
- Add a retry-attempt counter and automatic escalation after N failures
- Verify a custom sending domain on Resend for production email delivery